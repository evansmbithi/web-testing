...
//		FirefoxDriver driver = (FirefoxDriver) WebTesting.launchDriver("https://www.google.com", "firefox");
		...
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "log(58 x"));
		} catch (TimeoutException ex) {
		...
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "log(58 x 6"));
		} catch (TimeoutException ex) {
		...
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "log(58 x 6 ÷ 2"));
		} catch (TimeoutException ex) {
			fail("\"2\" was not input.");
		}
		...
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "log(58 x 6 ÷ 2 - 7"));
		} catch (TimeoutException ex) {
			fail("\"7\" was not input.");
		}
		...
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "log(58 x 6 ÷ 2 - 74"));
		} catch (TimeoutException ex) {
			fail("\"4\" was not input.");
		}
...
//		FirefoxDriver driver = (FirefoxDriver) WebTesting.launchDriver("https://www.google.com", "firefox");
		...
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'63 x 2\']"));
		} catch (NoSuchElementException ex) {
			fail("\"2\" was not input.");
		}
