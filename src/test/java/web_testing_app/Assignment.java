...
//		FirefoxDriver driver = (FirefoxDriver) WebTesting.launchDriver("https://www.google.com", "firefox");
		...
		try {
			longWait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//g-raised-button[@jsaction=\"dArJMd\"]")));
		} catch (TimeoutException ex) {
...
//		FirefoxDriver driver = (FirefoxDriver) WebTesting.launchDriver("https://www.google.com", "firefox");
		...
		try {
			testAgainButton = driver.findElement(By.xpath("//g-raised-button[@jsaction=\"iyDKIb\"]"));
		} catch (NoSuchElementException ex) {
...
//		FirefoxDriver driver = (FirefoxDriver) WebTesting.launchDriver("https://www.google.com", "firefox");
		...
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'63 x 21\']"));
		} catch (NoSuchElementException ex) {
			fail("\"63 x 21\" was not input.");
		}
		...
		/*CODE*/
		try {
			shortWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@jsname=\'DfiOAc\']")));
		} catch (TimeoutException ex) {
			fail("\"log()\" button not found.");
		}

		driver.findElement(By.xpath("//div[@jsname=\'DfiOAc\']")).click(); //log()

		try {
			shortWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@jsname=\'Ax5wH\']"));
		} catch (TimeoutException ex) {
			fail("\"5\" button not found.");
		}

		driver.findElement(By.xpath("//div[@jsname=\'Ax5wH\']")).click(); //5

		try {
			shortWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@jsname=\'T7PMFe\']"));
		} catch (TimeoutException ex) {
			fail("\"8\" button not found.");
		}

		driver.findElement(By.xpath("//div[@jsname=\'T7PMFe\']")).click();//8

		try {
			shortWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@jsname=\'YovRWb\']"));
		} catch (TimeoutException ex) {
			fail("\"x\" button not found.");
		}

		driver.findElement(By.xpath("//div[@jsname=\'YovRWb\']")).click();//x

		try {
			shortWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@jsname=\'abcgof\']"));
		} catch (TimeoutException ex) {
			fail("\"6\" button not found.");
		}

		driver.findElement(By.xpath("//div[@jsname=\'abcgof\']")).click();//6

		try {
			shortWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@jsname=\'WxTTNd\']"));
		} catch (TimeoutException ex) {
		...
		try {
			shortWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@jsname=\'lVjWed\']"));
		} catch (TimeoutException ex) {
			fail("\"2\" button not found.");
		}

		driver.findElement(By.xpath("//div[@jsname=\'lVjWed\']")).click();//2

		try {
			shortWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@jsname=\'pPHzQc\']"));
		} catch (TimeoutException ex) {
			fail("\"-\" button not found.");
		}
		...
		try {
			shortWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@jsname=\'rk7bOd\']"));
		} catch (TimeoutException ex) {
			fail("\"7\" button not found.");
		}

		driver.findElement(By.xpath("//div[@jsname=\'rk7bOd\']")).click();//7

		try {
			shortWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@jsname=\'xAP7E\']"));
		} catch (TimeoutException ex) {
			fail("\"4\" button not found.");
		}
		...
		try {
			...
			fail("\"log(58 × 6 ÷ 2 - 74)\" was not input.");
		}
		...
		try {
			shortWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@jsname=\"SLn8gc\"]"));
		} catch (TimeoutException ex) {
			fail("\"AC\" button not found.");
		}
...
//		FirefoxDriver driver = (FirefoxDriver) WebTesting.launchDriver("https://www.google.com", "firefox");
		...
		driver.findElement(By.cssSelector("div[jsname=\'T7PMFe\']")).click(); //8
		driver.findElement(By.cssSelector("div[jsname=\'rk7bOd\']")).click(); //7
		driver.findElement(By.cssSelector("div[jsname=\"XSr6wc\"]")).click(); //+
		...
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'63 x \']"));
		} catch (NoSuchElementException ex) {
			fail("\"+\" was not input.");
		}
		...
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'21\']"));
		} catch (NoSuchElementException ex) {
			fail("\"52\" was not input.");
		}
		...
		driver.findElement(By.cssSelector("div[jsname=\'XoxYJ\']")).click(); //9


		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'45 ÷ 9\']"));
		} catch (NoSuchElementException ex) {
			fail("\"45 ÷ 9\" was not input.");
		}
		...
		// HINT: you don't need the last parentheses
		/*CODE*/
		driver.findElement(By.cssSelector("div[jsname=\'DfiOAc\']")).click(); //log()
		driver.findElement(By.cssSelector("div[jsname=\'Ax5wH\']")).click(); //5
		driver.findElement(By.cssSelector("div[jsname=\'T7PMFe\']")).click();//8
		driver.findElement(By.cssSelector("div[jsname=\'YovRWb\']")).click();//x
